...
from scine_chemoton.utilities.database_initialization.insert_initial_structure import insert_initial_structure
...
from scine_chemoton.gears.network_refinement.refinement import ReactionRefinementOptions
...
from scine_chemoton.gears.elementary_steps.minimum_energy_conformer import MinimumEnergyConformerElementarySteps
...
def main() -> None:
    ...
    if wipe:
        ...
        time.sleep(1.0)
        # Load initial data
        methanol = "methanol.xyz"
        formaldehyde = "formaldehyde.xyz"
    ...
    #dissociations_gear.options.aggregate_filter = AggregateFilter()
    #dissociations_gear.options.enable_unimolecular_trials = True
    #dissociations_gear.options.enable_bimolecular_trials = False
    #dissociations_gear.options.trial_generator = FastDissociations()
    #trial_generator_options = dissociations_gear.options.trial_generator.options
    #trial_generator_options.reactive_site_filter = ReactiveSiteFilter()
    #trial_generator_options.further_exploration_filter = FurtherExplorationFilter()
    #trial_generator_options.model = model
    #trial_generator_options.unimolecular_options.job = db.Job("scine_dissociation_cut")
    #trial_generator_options.unimolecular_options.cutting_job_settings = default_cutting_settings()
    #trial_generator_options.unimolecular_options.min_bond_dissociations = 1
    #trial_generator_options.unimolecular_options.max_bond_dissociations = 1
    #trial_generator_options.unimolecular_options.enable_further_explorations = False
    #trial_generator_options.unimolecular_options.always_further_explore_dissociative_reactions = True
    #trial_generator_options.unimolecular_options.further_job = nt_job
    #trial_generator_options.unimolecular_options.further_job_settings = nt_settings
    ...
    elementary_step_gear = MinimumEnergyConformerElementarySteps()
    elementary_step_gear.options.trial_generator = BondBased()
    #elementary_step_gear.options.trial_generator.options.model = model
    ...
    #              the same changes.
    elementary_step_gear.options.trial_generator.options.bimolecular_options.min_bond_modifications = 0
    elementary_step_gear.options.trial_generator.options.bimolecular_options.max_bond_modifications = 2
    elementary_step_gear.options.trial_generator.options.bimolecular_options.min_inter_bond_formations = 0
    elementary_step_gear.options.trial_generator.options.bimolecular_options.max_inter_bond_formations = 2
    elementary_step_gear.options.trial_generator.options.bimolecular_options.min_intra_bond_formations = 0
    elementary_step_gear.options.trial_generator.options.bimolecular_options.max_intra_bond_formations = 2
    elementary_step_gear.options.trial_generator.options.bimolecular_options.min_bond_dissociations = 0
    elementary_step_gear.options.trial_generator.options.bimolecular_options.max_bond_dissociations = 2
    elementary_step_gear.options.trial_generator.options.bimolecular_options.\
        complex_generator.options.number_rotamers = 3
    elementary_step_gear.options.trial_generator.options.bimolecular_options.\
        complex_generator.options.number_rotamers_two_on_two = 2
    elementary_step_gear.options.trial_generator.options.bimolecular_options.\
        complex_generator.options.multiple_attack_points = True
    ...
    #              coordinates. This does not imply that the eventually resulting elementary steps include
    #              the same changes.
    elementary_step_gear.options.trial_generator.options.unimolecular_options.min_bond_modifications = 0
    elementary_step_gear.options.trial_generator.options.unimolecular_options.max_bond_modifications = 2
    elementary_step_gear.options.trial_generator.options.unimolecular_options.min_bond_formations = 0
    elementary_step_gear.options.trial_generator.options.unimolecular_options.max_bond_formations = 2
    elementary_step_gear.options.trial_generator.options.unimolecular_options.min_bond_dissociations = 0
    elementary_step_gear.options.trial_generator.options.unimolecular_options.max_bond_dissociations = 2
    ...
    elementary_step_gear.options.trial_generator.options.bimolecular_options.job = nt_job
    elementary_step_gear.options.trial_generator.options.bimolecular_options.job_settings = nt_settings
    elementary_step_gear.options.trial_generator.options.bimolecular_options.minimal_spin_multiplicity = False
    elementary_step_gear.options.trial_generator.options.unimolecular_options.job = nt_job
    #      Associative job settings are applied when at least one bond formation is included in the trial coordinate
    elementary_step_gear.options.trial_generator.options.unimolecular_options.job_settings_associative = nt_settings
    ...
    elementary_step_gear.options.trial_generator.options.unimolecular_options.job_settings_disconnective = nt_settings
    ...
    elementary_step_gear.options.trial_generator.options.unimolecular_options.job_settings_dissociative = nt_settings
    # 4.4) Add filters (default ones, filter nothing)
    elementary_step_gear.options.trial_generator.options.reactive_site_filter = ReactiveSiteFilter()
    elementary_step_gear.options.aggregate_filter = AggregateFilter()
    # Run
    ...
    refinement_gear.options.refinements = ReactionRefinementOptions(
    ...
    refinement_gear.options.post_refinement_model = post_refinement_model
    ...
    kinetics_gear.options.max_allowed_barrier = 400.0  # kJ/mol
