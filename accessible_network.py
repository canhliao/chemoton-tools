...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--molecule-output", default=ACCESSIBLE_NETWORK_DEFAULTS["molecule_output"])
    parser.add_argument("--reaction-output", default=ACCESSIBLE_NETWORK_DEFAULTS["reaction_output"])
